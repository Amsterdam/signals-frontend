  ...
  sizes.forEach((size) => {
    describe(`Create signal overlast bezoekers, resolution is: ${size}`, () => {
      ...
      it('Should create the signal', () => {
        ...
        cy.contains('Volgendeasdfkhjasdf').click()
        ...
        cy.contains(
          questions.overlastBedrijvenEnHoreca.extra_bedrijven_horeca_personen
            .label
        ).should('be.visible')
        ...
        cy.contains(
          questions.overlastBedrijvenEnHoreca.extra_bedrijven_horeca_tijdstippen
            .label
        ).should('be.visible')
