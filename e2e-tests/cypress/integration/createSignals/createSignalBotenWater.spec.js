...
describe("Create signal category boten 'geluid op het water'", () => {
  describe('Create signal boten', () => {
    ...
    it('Should search for an address', () => {
      cy.server();
      cy.getAddressRoute();
      cy.route('POST', '**/signals/category/prediction', 'fixture:predictions/waterGeluid.json').as('prediction');
...
describe("Create signal category boten 'wrak in het water'", () => {
  describe('Create signal boten', () => {
    ...
    it('Should search for an address', () => {
      cy.server();
      cy.getAddressRoute();
      cy.route('POST', '**/signals/category/prediction', 'fixture:predictions/waterWrak.json').as('prediction');
