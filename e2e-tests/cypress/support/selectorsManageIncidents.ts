...
export const MANAGE_SIGNALS = {
  ...
  firstSignalAdres: 'tbody > :nth-child(1) > :nth-child(9) > a',
  firstSignalDag: '[data-testid="incidentDaysOpen"] > a',
  firstSignalDatumTijd: 'tbody > :nth-child(1) > :nth-child(5) > a',
  firstSignalIcon: 'tbody > :nth-child(1) > :nth-child(1) > a > span',
  firstSignalId: 'tbody > :nth-child(1) > :nth-child(3) > a',
  firstSignalStadsdeelName: 'tbody > :nth-child(1) > :nth-child(8) > a',
  firstSignalStatus: 'tbody > :nth-child(1) > :nth-child(8) > a',
  firstSignalSubcategorie: 'tbody > :nth-child(1) > :nth-child(6) > a',
  firstSignalUrgentie: 'tbody > :nth-child(1) > :nth-child(1) > > a',
