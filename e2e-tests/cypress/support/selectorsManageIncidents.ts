...
export const MANAGE_SIGNALS = {
  ...
  firstSignalDatumTijd: 'tbody > :nth-child(1) > :nth-child(5) > span > a',
  firstSignalIcon: 'tbody > :nth-child(1) > :nth-child(1) > span > a > span',
  firstSignalId: 'tbody > :nth-child(1) > :nth-child(3) > span > a',
  firstSignalStadsdeelName: 'tbody > :nth-child(1) > :nth-child(8) > span > a',
