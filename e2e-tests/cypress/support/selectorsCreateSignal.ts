...
export const CREATE_SIGNAL = {
  ...
  buttonGPS: '[data-testid=gps-button]',
  buttonUploadFile: '#fileUpload',
  buttonVolgende: '[data-testid="next-button"]',
  checkBoxSharingAllowed: '#sharing_allowed',
  descriptionInfo: '[data-testid="description-info"]',
  disclaimer: '[data-testid=disclaimer]',
  dropdownDag: '[data-testid=select-day]',
  dropdownUur: '[data-testid=select-hours]',
  dropdownMinuten: '[data-testid=select-minutes]',
  ...
  errorSmallFile: '[data-testid=file-input-error]',
  ...
  mapStaticImage: '[data-testid=map-static-image]',
  mapStaticMarker: '[data-testid=map-static-marker]',
...
export const CONTAINERS = {
  ...
  buttonRemoveContainer: '[data-testid*="container-list-remove"]',
  ...
  containerListItem: '[data-testid*="container-list-item"]',
  inputContainerNummer: '#unregisteredContainerInput',
  legendaItemBrood: '[data-testid=legend-panel-list-item-brood]',
  legendaItemGlas: '[data-testid=legend-panel-list-item-glas]',
  legendaItemGFT: '[data-testid=legend-panel-list-item-GFT]',
  legendaItemPapier: '[data-testid=legend-panel-list-item-papier]',
  legendaItemPlastic: '[data-testid=legend-panel-list-item-plastic]',
  legendaItemRestafval: '[data-testid=legend-panel-list-item-rest]',
  legendaItemTextiel: '[data-testid=legend-panel-list-item-textiel]',
};

export const EIKENPROCESSIERUPS = {
  buttonMeldDezeBoom: 'button:contains("Meld deze boom")',
  buttonRemoveBoom: '[data-testid*="selection-list-remove"]',
  boomListItem: '[data-testid*="selection-list-item"]',
  checkBoxBoomNietOpKaart: '#unregisteredCaterpillarCheckbox',
  legendaItemEik: '[data-testid=legend-panel-list-item-oak]',
  legendaItemIsGemeld: '[data-testid=legend-panel-list-item-is-reported]',
...
export const GENERAL_MAP = {
  ...
  buttonKiesOpKaart: '[data-testid=choose-on-map]',
  ...
  panelInfo: '[data-testid=panel-desktop]',
  panelLegend: '[data-testid=legend-panel]',
};
...
export const KLOK = {
  ...
  mapSelectKlok: '[data-testid=map-select]',
...
export const LANTAARNPAAL = {
  ...
  legendContentText: '.legend-content-text',
  legendHeader: '.legend-header',
  mapSelectLamp: '[data-testid=map-select]',
