...
export const CHANGE_STATUS = {
  ...
  originalStatus: '[data-testid="originalStatus"]',
...
export const DEELMELDING = {
  ...
  childIncident: '[data-testid="childIncidentListItem"]',
...
export const SIGNAL_DETAILS = {
  ...
  deelmeldingBlockValue: '[data-testid="childIncidentsDisplayValue"]',
  deelmeldingen: '[data-testid="childIncidents"]',
  deelmeldingId: '[data-testid="childIncidentsIdDisplayValue"]',
