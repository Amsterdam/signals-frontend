...
describe('ProtectedRoute component', () => {
  ...
  it('should NOT render the component when doesn\'t have access', () => {
    render(withAppContext(<ProtectedRoute exact path="/test" component={TestComponent} />));
  ...
  it('should render the component when has access', () => {
    ...
    render(withAppContext(<ProtectedRoute exact path="/test" component={TestComponent} role="role" />));
  ...
  it('should render the component when has group access', () => {
    ...
    render(withAppContext(<ProtectedRoute exact path="/test" component={TestComponent} roleGroup="roleGroup" />));
