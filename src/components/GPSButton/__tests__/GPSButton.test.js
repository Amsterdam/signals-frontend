...
describe('components/GPSButton', () => {
  it('should render button with icon', () => {
    const { container, getByTestId } = render(withAppContext(<GPSButton onLocationSuccess={() => {}} />));
  ...
  it('should render the loadingIndicator', async () => {
    ...
    await waitFor(() => expect(queryByTestId('loadingIndicator')).not.toBeInTheDocument(), { timeout: 10 });
  });
  ...
  it('should call onLocationSuccess', () => {
    ...
    const { getByTestId } = render(withAppContext(<GPSButton onLocationSuccess={onLocationSuccess} />));
  ...
  it('should call onLocationChange', () => {
    ...
    const { getByTestId } = render(withAppContext(<GPSButton onLocationChange={onLocationChange} />));
  ...
  it('should call onLocationError', () => {
    ...
    const { getByTestId } = render(
      withAppContext(<GPSButton onLocationSuccess={onLocationSuccess} onLocationError={onLocationError} />)
    );
