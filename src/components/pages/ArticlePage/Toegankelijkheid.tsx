...
const Toegankelijkheid: FC = () => (
  <BasePage documentTitle="Toegankelijkheid" pageTitle="Toegankelijkheid">
    ...
    <Paragraph>
      ...
      gebruiken en bekijken. Ook bijvoorbeeld blinden en slechtzienden of mensen
      met een andere beperking. De gemeente Amsterdam werkt er hard aan om de
      website zo gebruiksvriendelijk mogelijk te maken. Hiervoor volgen we de
      richtlijnen van de overheid. Zo maken we de website voor iedereen
      toegankelijk.
    </Paragraph>
