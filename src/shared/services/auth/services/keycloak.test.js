  ...
  describe('keycloak', () => {
    describe('constructor', () => {
      ...
      it('instantiates listeners to start and stop refresh interval', () => {
        ...
        const logoutSpy = jest.spyOn(keycloak.keycloak, 'logout').mockReturnValue();
    ...
    describe('isAuthenticated', () => {
      it('returns true if user is authenticated', () => {
        ...
        const isTokenExpiredMock = jest.spyOn(keycloak.keycloak, 'isTokenExpired').mockReturnValue(false);
      ...
      it('returns false if token is expired', () => {
        keycloak.keycloak.authenticated = true;
        const isTokenExpiredMock = jest.spyOn(keycloak.keycloak, 'isTokenExpired').mockReturnValue(true);
    ...
    describe('getAuthHeaders', () => {
      it('returns auth headers', () => {
        ...
        expect(keycloak.getAuthHeaders()).toStrictEqual({ Authorization: 'Bearer 123AccessTokenForAuthHeaders' });
      });
