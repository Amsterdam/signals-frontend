...
export type GetSourcesSuccessAction = Action<typeof GET_SOURCES_SUCCESS, string[]>;
...
export const authenticateUser = (credentials: UserCredentials): AuthenticateUserAction => ({
...
export const showGlobalNotification = (payload: GlobalNotification): ShowGlobalNotificationAction => ({
...
export const getSourcesSuccess = (payload: string[]): GetSourcesSuccessAction => ({
