...
export const REQUEST_CATEGORIES = 'src/App/REQUEST_CATEGORIES';
export const REQUEST_CATEGORIES_SUCCESS = 'src/App/REQUEST_CATEGORIES_SUCCESS';
export const REQUEST_CATEGORIES_ERROR = 'src/App/REQUEST_CATEGORIES_ERROR';
