...
describe('containers/App/services', () => {
  ...
  it('should inject reducer', () => {
    const mockedInjectReducerModel = (injectReducerModel as unknown) as jest.Mock<typeof injectReducerModel>;
  ...
  it('should inject saga', () => {
    const mockedInjectSagaModel = (injectSagaModel as unknown) as jest.Mock<typeof injectSagaModel>;
