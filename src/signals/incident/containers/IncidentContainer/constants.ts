...
export const REMOVE_KEYS_FROM_INCIDENT = 'src/IncidentContainer/REMOVE_KEYS_FROM_INCIDENT';
...
export const CREATE_INCIDENT_ERROR = 'sia/IncidentContainer/CREATE_INCIDENT_ERROR';
...
export const GET_QUESTIONS_SUCCESS = 'sia/IncidentContainer/GET_QUESTIONS_SUCCESS';
