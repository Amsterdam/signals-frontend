...
describe('Form component <MultiTextInput />', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render multi text correctly', () => {
      const { rerender } = render(withAppContext(<MultiTextInput {...props} meta={{ ...meta, isVisible: false }} />));

      expect(screen.queryByText('field label')).not.toBeInTheDocument();
      expect(screen.queryByRole('textbox')).not.toBeInTheDocument();

      rerender(withAppContext(<MultiTextInput {...props} meta={{ ...meta, isVisible: true }} />));
    ...
    it('should render multi text without value correctly', () => {
      ...
      render(withAppContext(<MultiTextInput {...props} meta={{ ...meta, isVisible: true }} />));
