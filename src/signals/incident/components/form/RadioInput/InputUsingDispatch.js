...
const InputUsingDispatch = ({ checked, id, idAttr, label, info, name, resetsStateOnChange }) => {
...
InputUsingDispatch.defaultProps = {
  checked: false,
  info: '',
  resetsStateOnChange: false,
};

InputUsingDispatch.propTypes = {
...
export default InputUsingDispatch;
