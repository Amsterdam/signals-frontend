...
describe('signals/incident-management/actions', () => {
  it('should dispatch getDistrictsSuccess action', () => {
    ...
    testActionCreator(actions.getDistrictsSuccess, constants.GET_DISTRICTS_SUCCESS, payload);
  });
  ...
  it('should dispatch getDistrictsFailed action', () => {
    ...
    testActionCreator(actions.getDistrictsFailed, constants.GET_DISTRICTS_FAILED, payload);
  });
  ...
  it('should dispatch orderingChanged action', () => {
    ...
    testActionCreator(actions.orderingChanged, constants.ORDERING_CHANGED, ordering);
  });
  ...
  it('should dispatch requestIncidentsSuccess action', () => {
    ...
    testActionCreator(actions.requestIncidentsSuccess, constants.REQUEST_INCIDENTS_SUCCESS, incidents);
  });

  it('should dispatch requestIncidentsError action', () => {
    const error = new Error('nope');

    testActionCreator(actions.requestIncidentsError, constants.REQUEST_INCIDENTS_ERROR, error);
  });

  it('should dispatch applyFilterRefresh action', () => {
    testActionCreator(actions.applyFilterRefresh, constants.APPLY_FILTER_REFRESH);
  });

  it('should dispatch applyFilterRefreshStop action', () => {
    testActionCreator(actions.applyFilterRefreshStop, constants.APPLY_FILTER_REFRESH_STOP);
  });
  ...
  it('should dispatch searchIncidentsSuccess action', () => {
    ...
    testActionCreator(actions.searchIncidentsSuccess, constants.SEARCH_INCIDENTS_SUCCESS, incidents);
  });

  it('should dispatch searchIncidentsError action', () => {
    const error = new Error('nope');

    testActionCreator(actions.searchIncidentsError, constants.SEARCH_INCIDENTS_ERROR, error);
  });

  it('should dispatch patchIncidentSuccess action', () => {
    testActionCreator(actions.patchIncidentSuccess, constants.PATCH_INCIDENT_SUCCESS);
  });
});
