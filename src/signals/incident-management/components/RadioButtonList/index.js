 ...
 */
const RadioButtonList = ({ emptySelectionLabel, hasEmptySelectionButton, defaultValue, groupName, options, title }) => (
  <FilterGroup>
    {title && (
    ...
    {hasEmptySelectionButton && emptySelectionLabel && (
      <div className="antwoord">
        <input type="radio" id={`empty_${groupName}`} name={groupName} value="" defaultChecked={defaultValue === ''} />
    ...
    {options.map(({ key, value }) => (
      <div className="antwoord" key={key}>
        <input type="radio" id={key} name={groupName} value={key} defaultChecked={key === defaultValue} />
