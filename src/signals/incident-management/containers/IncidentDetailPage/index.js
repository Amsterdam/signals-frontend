...
import { requestIncident, resetSplitState } from 'models/incident/actions';
...
export class IncidentDetailPage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    ...
    this.onResetSplitState = this.onResetSplitState.bind(this);
  }
    ...
    const view = this.state.printView ? (
      ...
      (
        <div className="incident-detail-page container">
          <SplitNotificationBar payload={split} onClose={this.onResetSplitState} />
...
IncidentDetailPage.propTypes = {
  ...
  onResetSplitState: PropTypes.func.isRequired
};
...
export const mapDispatchToProps = (dispatch) => bindActionCreators({
  ...
  onResetSplitState: resetSplitState
}, dispatch);
