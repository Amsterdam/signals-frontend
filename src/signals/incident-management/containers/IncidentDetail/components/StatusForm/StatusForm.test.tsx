...
describe('signals/incident-management/containers/IncidentDetail/components/StatusForm', () => {
  ...
  it('is not possible to submit the status Afgehandeld when category is Overig-Overig', async () => {
    ...
    configuration.featureFlags.preventProcessingCategoryOverigOverigAndStatusAfgehandeld =
      true
  ...
  it('is not possible to submit the status Afgehandeld when category is Overig-Overig, but featureflag preventProcessingCategoryOverigOverigAndStatusAfgehandeld is false', async () => {
    const withCategoryOverigOverig = {
      ...incidentFixture,
      category: {
        ...incidentFixture.category,
