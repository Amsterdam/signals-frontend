...
import { subcategoriesHandlingTimesBySlug } from 'utils/__tests__/fixtures';
...
const renderWithContext = Component =>
  withAppContext(
    <IncidentDetailContext.Provider value={{ handlingTimesBySlug: subcategoriesHandlingTimesBySlug, update }}>
      {Component}
