...
import type { Incident, State, IncidentChild, HistoryEntry, Attachment, Result } from './types';
import type {
  RESET,
  CLOSE_ALL,
  SET_ERROR,
...
export type SetErrorAction = Action<typeof SET_ERROR, boolean | FetchError | undefined>;
export type SetAttachmentsAction = Action<typeof SET_ATTACHMENTS, Result<Attachment>>;
export type SetHistoryAction = Action<typeof SET_HISTORY, HistoryEntry[]>;
export type SetChildrenAction = Action<typeof SET_CHILDREN, Result<IncidentChild>>;
export type SetChildrenHistoryAction = Action<typeof SET_CHILDREN_HISTORY, HistoryEntry[][]>;
